# Generated by Django 3.2.5 on 2021-11-05 22:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now=True)),
                ('cmnt_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cmnt_to', to='tleak.upload')),
            ],
        ),
        migrations.CreateModel(
            name='Owner',
            fields=[
                ...
                ('profile_pic', models.CharField(blank=True, max_length=300, null=True)),
